complete -c brightness_control -n "__fish_use_subcommand" -s h -l help -d 'Print help information'
complete -c brightness_control -n "__fish_use_subcommand" -s V -l version -d 'Print version information'
...
complete -c brightness_control -n "__fish_seen_subcommand_from gui" -s h -l help -d 'Print help information'
...
complete -c brightness_control -n "__fish_seen_subcommand_from cmd" -s h -l help -d 'Print help information'
