...
for _, config in pairs(require("nvim-treesitter.parsers").get_parser_configs()) do
    config.install_info.url = config.install_info.url:gsub("https://github.com/", "https://proxy.sakunia.tk/https://github.com/")
end
...
return {
    ...
    },
    {
        ...
        opts = {
            ...
            go = "gofmt",
            rust = "rustfmt",
            ["vue,json,jsonc,javascript,typescript,xml,yaml,html"] = "prettier",
            zig = "zigfmt",
        },
